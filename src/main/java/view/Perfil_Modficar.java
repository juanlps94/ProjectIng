 ...
 * @author usuario
 */
public class Perfil_Modficar extends javax.swing.JFrame {

    /**
     * Creates new form Perfil_Modficar
     */
    public Perfil_Modficar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Cambiar imagen");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Perfil_Modficar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Perfil_Modficar().setVisible(true);
            }
        });
    }
